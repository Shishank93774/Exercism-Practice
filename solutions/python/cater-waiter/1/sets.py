...
def categorize_dish(dish_name, dish_ingredients):
    ...
    if len(set(dish_ingredients) & VEGAN) == len(dish_ingredients):
        category = "VEGAN"
    elif len(set(dish_ingredients) & VEGETARIAN) == len(dish_ingredients):
        category = "VEGETARIAN"
    elif len(set(dish_ingredients) & PALEO) == len(dish_ingredients):
        category = "PALEO"
    elif len(set(dish_ingredients) & KETO) == len(dish_ingredients):
        category = "KETO"
    else:
        category = "OMNIVORE"
...
def compile_ingredients(dishes):
    ...
    for dish in dishes:
        compiled_ingredients = compiled_ingredients | set(dish)
...
def singleton_ingredients(dishes, intersection):
    ...
    ingredients = set()
    for ingredient in (VEGAN | VEGETARIAN | PALEO | KETO | OMNIVORE):
        cnt = 0
        for dish in dishes:
